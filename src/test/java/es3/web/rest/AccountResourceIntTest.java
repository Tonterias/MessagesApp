package es3.web.rest;

import es3.config.Constants;
import es3.Test3ElasticsocialApp;
import es3.domain.Authority;
import es3.domain.PersistentToken;
import es3.domain.User;
import es3.repository.AuthorityRepository;
import es3.repository.PersistentTokenRepository;
import es3.repository.UserRepository;
import es3.security.AuthoritiesConstants;
import es3.service.MailService;
import es3.service.dto.UserDTO;
import es3.web.rest.errors.ExceptionTranslator;
import es3.web.rest.vm.KeyAndPasswordVM;
import es3.web.rest.vm.ManagedUserVM;
import es3.service.UserService;
...
@SpringBootTest(classes = Test3ElasticsocialApp.class)
