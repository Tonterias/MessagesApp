package es3.repository;

import es3.Test3ElasticsocialApp;
import es3.config.Constants;
import es3.config.audit.AuditEventConverter;
import es3.domain.PersistentAuditEvent;
...
import static es3.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
